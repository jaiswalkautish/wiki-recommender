    ...
    $.fn.hovercard = function (options) {
        ...
        if ($('#css-hovercard').length <= 0) {
            var hovercardTempCSS = '<style id="css-hovercard" type="text/css">' +
                                    ...
                                    '.hc-details-open-left { left: auto; right:-10px; text-align:left; margin-left:0px; margin-right:0; } ' +
        ...
        return this.each(function () {
            ...
            obj.wrap('<div class="hc-preview" /><p>');
            ...
            var hcDetails = '<div class="hc-details" >' + hcImg + options.detailsHTML + '</p></div>';
